...
export default function PostFreeEntryPage() {
  return <main style={{ maxWidth: 860, margin: "0 auto", padding: "120px 20px 72px", color: "#263b35" }}>
    <section style={{ padding: "clamp(22px, 5vw, 44px)", borderRadius: 18, background: "#fff", border: "1px solid #cddbd7", boxShadow: "0 16px 50px rgba(38,59,53,.12)" }}>
